...
class NoteControllerTest {
    ...
    @MockBean
    private NoteProxyService mockNoteProxyService;

    @Test
    void testShowAddNoteForm() throws Exception {
        final MockHttpServletResponse response = mockMvc.perform(get("/note/add")
                        .param("patientId", "0")
    ...
    void testSubmitAddNoteForm() throws Exception {
        ...
        final MockHttpServletResponse response = mockMvc.perform(post("/note/add")
                        .param("id", "id")
                        .param("patientId", "0")
                        .param("note", "note")
                        .accept(MediaType.TEXT_HTML))
    ...
    void testDeletePatient() throws Exception {
        final MockHttpServletResponse response = mockMvc.perform(get("/note/delete/{id}/{patientId}", "id", 0)
                        .accept(MediaType.TEXT_HTML))
                .andReturn().getResponse();
