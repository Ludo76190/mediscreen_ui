...
class PatientControllerTest {
    ...
    @MockBean
    private PatientProxyService mockPatientProxy;
    @MockBean
    private NoteProxyService mockNoteProxy;
    @MockBean
    ...
    void testGetPatients() throws Exception {
        ...
        when(mockPatientProxy.getPatients()).thenReturn(patients);
    ...
    void testGetPatients_PatientProxyServiceReturnsNoItems() throws Exception {
        when(mockPatientProxy.getPatients()).thenReturn(Collections.emptyList());
